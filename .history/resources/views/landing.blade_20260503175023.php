...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* FOOTER */
  footer { background: #0D0728; padding: 40px 5% 100px; border-top: 1px solid rgba(255,255,255,0.06); }
  ...
  @media (max-width: 900px) {
    ...
    .stats-bar { grid-template-columns: repeat(3, 1fr); padding: 24px 2%; }
    .stat-num { font-size: 24px; }
    .stat-label { font-size: 10px; }
    .stat-item { padding: 8px 4px; }
    .stat-item + .stat-item { border-left: 1px solid rgba(255,255,255,0.08); border-top: none; }
    .nav-links { display: none; }
    .sticky-ori { display: none; }
    .pricing-card-wrap { grid-template-columns: 1fr; }

    /* Compact Sticky Bar for Mobile */
    .sticky-bar { padding: 10px 4%; gap: 10px; }
    .sticky-label { font-size: 11px; }
    .sticky-price { font-size: 16px; }
    .sticky-cta { padding: 8px 18px; font-size: 13px; border-radius: 8px; }
...
<nav>
  ...
  <div style="display: flex; align-items: center; gap: 20px;">
    <a href="{{ route('login') }}" style="color: rgba(255,255,255,0.7); text-decoration: none; font-size: 14px; font-weight: 700;">Masuk</a>
...
<section class="pricing" id="harga">
  ...
  <div class="pricing-card-wrap">
    ...
    <div class="pricing-card">
      ...
      <div class="pricing-slot-wrap">
        <div class="pricing-slot-text"><strong>Hanya 62 slot lagi</strong> di harga ini — setelahnya naik!</div>
        <div class="pricing-bar"><div class="pricing-bar-fill" style="width: 38%"></div></div>
        <div class="pricing-slot-count">38 dari 100 slot Early Bird terpakai</div>
      </div>
      <ul class="pricing-features">
