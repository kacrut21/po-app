...
<section class="hero" id="home">
  <div class="hero-inner">
    <div>
      <div class="hero-badge"><span></span> Aplikasi Pre-Order #1 untuk Katering & Aqiqah</div>
      <h1>Pre-Order Makin <em>Rapi,</em> Bisnis Makin <em>Untung</em></h1>
      <p class="hero-sub">Dari terima pesanan, pantau produksi, sampai kirim invoice ke WhatsApp pembeli — semua dalam satu aplikasi. Tanpa Excel, tanpa ribet.</p>
    ...
    <div class="hero-mockup">
      <div class="mockup-screen">
        ...
        <div class="mockup-order-item">
          <div class="mockup-avatar">AS</div>
          <div><div class="mockup-order-name">Aqiqah Sari</div><div class="mockup-order-sub">80 porsi Nasi</div></div>
          <div class="mockup-badge badge-masuk">Masuk</div>
        </div>
        <div class="mockup-order-item">
          <div class="mockup-avatar" style="background:#00b894">BU</div>
          <div><div class="mockup-order-name">Bu Rini Catering</div><div class="mockup-order-sub">50 porsi Nasi Box</div></div>
          <div class="mockup-badge badge-kirim">Siap Kirim</div>
        </div>
        <div class="mockup-order-item">
          <div class="mockup-avatar" style="background:#e17055">PK</div>
          <div><div class="mockup-order-name">Pak Hendra</div><div class="mockup-order-sub">120 porsi Aqiqah</div></div>
...
<section class="pain">
  ...
  <div class="section-title">Masih Kelola Pre-Order<br>Pakai Catatan Manual?</div>
  <p class="section-sub">Kalau iya, kamu pasti udah pernah ngalamin masalah-masalah ini yang bikin bisnis nggak maksimal.</p>
  <div class="pain-grid">
    <div class="pain-card">
...
<section class="features" id="fitur">
  <div class="features-header">
    ...
    <p class="section-sub" style="margin: 0 auto; text-align:center">Satu aplikasi untuk kelola seluruh operasional pre-order bisnis makananmu.</p>
  </div>
  <div class="feat-grid">
    <div class="feat-card">
...
<section class="testi" id="testimoni">
  ...
  <div class="testi-grid">
    <div class="testi-card">
      ...
      <p class="testi-text">"Dulu kelola order aqiqah pake Excel ribet banget. Sekarang pakai OrderIn semua keliatan rapi, invoice langsung kekirim ke WA pembeli. Recommended banget!"</p>
      <div class="testi-author">
        <div class="testi-avatar">SR</div>
        <div>
          <div class="testi-name">Siti Rahayu</div>
          <div class="testi-biz">Dapur Aqiqah Berkah, Bandung</div>
        </div>
      </div>
    </div>
    <div class="testi-card">
      <div class="testi-stars">★★★★★</div>
      <p class="testi-text">"Fitur kalkulator HPP-nya ini yang bikin saya sadar selama ini jual terlalu murah. Sekarang margin saya naik dari 15% jadi 38% setelah pakai OrderIn!"</p>
      <div class="testi-author">
        <div class="testi-avatar" style="background:#0984e3">BH</div>
        <div>
          <div class="testi-name">Budi Hartono</div>
          <div class="testi-biz">Nasi Box Pak Budi, Jakarta</div>
        </div>
      </div>
    </div>
    <div class="testi-card">
      <div class="testi-stars">★★★★★</div>
      <p class="testi-text">"Usaha katering saya makin profesional sejak pakai ini. Pelanggan happy karena langsung dapat invoice WA yang rapi. Harga 99rb buat lifetime itu worth it banget!"</p>
      <div class="testi-author">
        <div class="testi-avatar" style="background:#00b894">DW</div>
        <div>
          <div class="testi-name">Dewi Wulandari</div>
          <div class="testi-biz">Catering Bu Dewi, Surabaya</div>
        </div>
      </div>
    </div>
  </div>
...
<section class="faq" id="faq">
  ...
  <div class="faq-item">
    ...
    <div class="faq-a">OrderIn dirancang untuk bisnis pre-order makanan seperti katering, aqiqah, nasi box, hampers, dan sejenisnya. Cocok untuk UMKM dari skala rumahan sampai yang sudah lumayan besar.</div>
  </div>
  <div class="faq-item">
...
<section class="cta-final">
  ...
  <p>Bergabung dengan ratusan pebisnis kuliner yang sudah pakai OrderIn.<br>Bayar sekali, untung selamanya.</p>
  <a href="https://lynk.id/GANTI_LINK_KAMU" class="btn-primary" target="_blank">🛒 Beli Sekarang — Rp 99.000</a>
</section>
